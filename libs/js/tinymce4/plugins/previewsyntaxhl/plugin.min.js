...
tinymce.PluginManager.add('previewsyntaxhl', function (editor) {
    editor.addCommand('mcePreviewSyntaxHL', function () {
    ...
    editor.addButton('previewsyntaxhl', {
        icon: 'preview',
        title: 'Preview',
        cmd: 'mcePreviewSyntaxHL'
    });

    editor.addMenuItem('previewsyntaxhl', {
        icon: 'preview',
        text: 'Preview',
        cmd: 'mcePreviewSyntaxHL',
        context: 'view'
